(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('younghipsterApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-younghipsterApp-error');
                var entityKey = httpResponse.headers('X-younghipsterApp-params');
                if (errorHeader) {
